...
export default function dashbaord({darkMode}) {
  return (
    <div >
      <main className='pt-20'>
                <div class="grid mb-4 pb-10 px-2 mx-4 rounded-3xl bg-gray-100 border-4 border-green-400 ">

                    <div class="grid grid-cols-12 gap-6">
                        <div class="grid grid-cols-12 col-span-12 gap-6 xxl:col-span-9">
                            <div class="col-span-12 mt-8">
                                <div class="flex items-center h-10 intro-y">
                                    <h2 class={`mr-5 text-lg font-medium truncate text-dark`}>Dashboard</h2>
                                </div>
                                <div class="grid grid-cols-12 gap-6 mt-5">
                                    <a class={`transform  hover:scale-105 transition duration-300 shadow-xl rounded-lg col-span-12 sm:col-span-6 xl:col-span-3 intro-y  ${darkMode ? 'bg-dark text-white' : 'bg-white text-dark'}`} href="#">
                                        <div class="p-5">
                                            ...
                                            <div class="ml-2 w-full flex-1">
                                                <div>
                                                    ...
                                                    <div class="mt-1 text-base ">Item Sales</div>
                                                </div>
                                            </div>
                                        </div>
                                    </a>
                                                    ...
                                                    <div class="py-2 align-middle inline-block min-w-full">
                                                        <div class="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg bg-white">
                                                            <table class="min-w-full divide-y divide-gray-200">
                                                                ...
                                                                <tbody class={` divide-y divide-gray-200 ${darkMode?'bg-dark text-white' : 'bg-white text-dark'}`}>
                                                                    <tr>
